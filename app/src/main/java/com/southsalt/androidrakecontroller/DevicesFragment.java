...
public class DevicesFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new ArrayAdapter<BluetoothDevice>(getActivity(), 0, listItems) {
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                TextView deviceNameTextView = view.findViewById(R.id.device_name_label);
                TextView deviceAddressTextView = view.findViewById(R.id.device_address);
                if(device.getName() == null || device.getName().isEmpty())
                    deviceNameTextView.setText("<unnamed>");
                else
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        getFragmentManager().beginTransaction().replace(R.id.fragment, fragment, "contoller").addToBackStack(null).commit();

        /*
        Intent intent = new Intent(getContext(), Controller.class);
